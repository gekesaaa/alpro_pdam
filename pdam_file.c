...
int validasi_tahun(){   //validasi untuk tahun pada pengecekan denda
	int angka;
    char karakter;
    if (scanf("%d%c",&angka,&karakter)!= 2 || angka < 2000 || angka > 2025 || karakter != '\n'){
        fflush(stdin);
        printf("\t Input invalid! \n Masukkan data yang benar : ");
...
char bangunan[15];
    ...
    if (klaster == 1) {
        ...
        printf("======================================================\n");
        printf("|                 FORMULIR DATA PEMBAYAR             |\n");
        printf("|                TAGIHAN AIR RUMAH TANGGA            |\n");
        printf("======================================================\n");
        printf("|  Nama                 : "); scanf("%[^\n]", nama); getchar();
        printf("|  Alamat               : "); scanf("%[^\n]", alamat); getchar();
        printf("======================================================\n");
	...
	printf ("|Klaster   : %s \n", bangunan);
	printf ("|Golongan  : %s \n", kode);
	printf ("|Waktu pembayaran   : %d hari \n", total);
	printf ("|Pemakaian : %d m^3 \n", pemakaian);
	printf ("|=============================================|\n");
	printf ("|Denda : %.3f \n", denda);
	printf ("|Tarif : Rp. %.3f \n", tarif);
	printf ("|BPM : Rp. %.3f \n", bpm);
	...
	printf ("|=============================================|\n");
	printf ("Untuk membuat struk silahkan tekan ENTER\n");
	...
	fprintf (ptr,"|Klaster   : %s \n", bangunan);
	fprintf (ptr,"|Golongan  : %s \n", kode);
	fprintf (ptr,"|Waktu pembayaran   : %d hari \n", total);
	fprintf (ptr,"|Pemakaian : %d m^3 \n", pemakaian);
	fprintf (ptr,"|=============================================|\n");
	fprintf (ptr,"|Denda : %.3f \n", denda);
	fprintf (ptr,"|Tarif : Rp. %.3f \n", tarif);
	fprintf (ptr,"|BPM : Rp. %.3f \n", bpm);
	fprintf (ptr,"|Biaya Admin : Rp. %.3f \n", BIAYA_ADM);
	fprintf (ptr,"|=============================================|\n");
	total_biaya = (BIAYA_ADM+bpm+tarif+denda);
	fprintf (ptr,"|Total Biaya : Rp. %.3f \n", total_biaya);
	fprintf (ptr,"|=============================================|\n");
